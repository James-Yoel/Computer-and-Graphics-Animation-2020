...
public class CustomCubeWithShader : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        colors[0] = new Color32(220, 220, 220, 255);
        colors[1] = new Color32(220, 220, 220, 255);
        colors[2] = new Color32(220, 220, 220, 255);
        colors[3] = new Color32(220, 220, 220, 255);
        ...
        colors[8] = new Color32(192, 192, 192, 255);
        colors[9] = new Color32(192, 192, 192, 255);
        colors[10] = new Color32(192, 192, 192, 255);
        colors[11] = new Color32(192, 192, 192, 255);
        ...
        colors[20] = new Color32(105, 105, 105, 255);
        colors[21] = new Color32(105, 105, 105, 255);
        colors[22] = new Color32(105, 105, 105, 255);
        colors[23] = new Color32(105, 105, 105, 255);
