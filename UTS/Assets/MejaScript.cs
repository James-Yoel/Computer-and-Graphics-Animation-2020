...
public class MejaScript : MonoBehaviour
{
    [SerializeField]
    ...
    void Start()
    {
        ...
        vertices[24] = new Vector3(9.0f, 0.0f, 0.0f);
        vertices[25] = new Vector3(10.0f, 0.0f, 0.0f);
        vertices[26] = new Vector3(9.0f, 0.0f, -1.0f);
        vertices[27] = new Vector3(10.0f, 0.0f, -1.0f);
        ...
        vertices[28] = new Vector3(9.0f, 3.0f, 0.0f);
        vertices[29] = new Vector3(10.0f, 3.0f, 0.0f);
        vertices[30] = new Vector3(9.0f, 3.0f, -1.0f);
        vertices[31] = new Vector3(10.0f, 3.0f, -1.0f);
        ...
        vertices[32] = new Vector3(9.0f, 0.0f, 0.0f);
        vertices[33] = new Vector3(10.0f, 0.0f, 0.0f);
        vertices[34] = new Vector3(9.0f, 3.0f, 0.0f);
        vertices[35] = new Vector3(10.0f, 3.0f, 0.0f);
        ...
        vertices[36] = new Vector3(9.0f, 0.0f, 0.0f);
        vertices[37] = new Vector3(9.0f, 0.0f, -1.0f);
        vertices[38] = new Vector3(9.0f, 3.0f, 0.0f);
        vertices[39] = new Vector3(9.0f, 3.0f, -1.0f);
        ...
        vertices[40] = new Vector3(10.0f, 0.0f, -1.0f);
        vertices[41] = new Vector3(9.0f, 0.0f, -1.0f);
        vertices[42] = new Vector3(10.0f, 3.0f, -1.0f);
        vertices[43] = new Vector3(9.0f, 3.0f, -1.0f);
        ...
        vertices[44] = new Vector3(10.0f, 0.0f, 0.0f);
        vertices[45] = new Vector3(10.0f, 0.0f, -1.0f);
        vertices[46] = new Vector3(10.0f, 3.0f, 0.0f);
        vertices[47] = new Vector3(10.0f, 3.0f, -1.0f);
        ...
        vertices[72] = new Vector3(9.0f, 0.0f, -3.0f);
        vertices[73] = new Vector3(10.0f, 0.0f, -3.0f);
        vertices[74] = new Vector3(9.0f, 0.0f, -4.0f);
        vertices[75] = new Vector3(10.0f, 0.0f, -4.0f);
        ...
        vertices[76] = new Vector3(9.0f, 3.0f, -3.0f);
        vertices[77] = new Vector3(10.0f, 3.0f, -3.0f);
        vertices[78] = new Vector3(9.0f, 3.0f, -4.0f);
        vertices[79] = new Vector3(10.0f, 3.0f, -4.0f);
        ...
        vertices[80] = new Vector3(9.0f, 0.0f, -3.0f);
        vertices[81] = new Vector3(10.0f, 0.0f, -3.0f);
        vertices[82] = new Vector3(9.0f, 3.0f, -3.0f);
        vertices[83] = new Vector3(10.0f, 3.0f, -3.0f);
        ...
        vertices[84] = new Vector3(9.0f, 0.0f, -4.0f);
        vertices[85] = new Vector3(9.0f, 0.0f, -3.0f);
        vertices[86] = new Vector3(9.0f, 3.0f, -4.0f);
        vertices[87] = new Vector3(9.0f, 3.0f, -3.0f);
        ...
        vertices[88] = new Vector3(10.0f, 0.0f, -4.0f);
        vertices[89] = new Vector3(9.0f, 0.0f, -4.0f);
        vertices[90] = new Vector3(10.0f, 3.0f, -4.0f);
        vertices[91] = new Vector3(9.0f, 3.0f, -4.0f);
        ...
        vertices[92] = new Vector3(10.0f, 0.0f, -3.0f);
        vertices[93] = new Vector3(10.0f, 0.0f, -4.0f);
        vertices[94] = new Vector3(10.0f, 3.0f, -3.0f);
        vertices[95] = new Vector3(10.0f, 3.0f, -4.0f);
        ...
        vertices[97] = new Vector3(10.0f, 3.0f, 0.0f);
        vertices[98] = new Vector3(0.0f, 3.0f, -4.0f);
        vertices[99] = new Vector3(10.0f, 3.0f, -4.0f);
        ...
        vertices[101] = new Vector3(10.0f, 4.0f, 0.0f);
        vertices[102] = new Vector3(0.0f, 4.0f, -4.0f);
        vertices[103] = new Vector3(10.0f, 4.0f, -4.0f);
        ...
        vertices[105] = new Vector3(10.0f, 3.0f, 0.0f);
        vertices[106] = new Vector3(0.0f, 4.0f, 0.0f);
        vertices[107] = new Vector3(10.0f, 4.0f, 0.0f);
        ...
        vertices[112] = new Vector3(10.0f, 3.0f, -4.0f);
        vertices[113] = new Vector3(0.0f, 3.0f, -4.0f);
        vertices[114] = new Vector3(10.0f, 4.0f, -4.0f);
        ...
        vertices[116] = new Vector3(10.0f, 3.0f, 0.0f);
        vertices[117] = new Vector3(10.0f, 3.0f, -4.0f);
        vertices[118] = new Vector3(10.0f, 4.0f, 0.0f);
        vertices[119] = new Vector3(10.0f, 4.0f, -4.0f);
